...
describe('<Basket />', () => {
  ...
  test('should add and remove items to the basket giving the correct sums', async () => {
    ...
    //   // Click 'Beans', 'Beans', 'Coke'
    //   fireEvent.click(screen.getByText('Beans'));
    //   fireEvent.click(screen.getByText('Beans'));
    //   fireEvent.click(screen.getByText('Coke'));
    //   expect(await getAllByText('item')).toHaveLength(6);
    //   expect(screen.getByText(/£2.90/i)).toBeInTheDocument(); // sub-total value
    //   expect(screen.getByText(/N\/A/i)).toBeInTheDocument(); // discount value
    //   expect(screen.getByText(/£2.90/i)).toBeInTheDocument(); // total to pay value
    //   // Click 'Coke'
    //   fireEvent.click(screen.getByText('Coke'));
    //   expect(await getAllByText('item')).toHaveLength(7);
    //   expect(screen.getByText(/£3.60/i)).toBeInTheDocument(); // sub-total value
    //   expect(screen.getByText(/0.40/i)).toBeInTheDocument(); // discount value
    //   expect(screen.getByText(/£3.20/i)).toBeInTheDocument(); // total to pay value
    //   // Click 'Beans'
    //   fireEvent.click(screen.getByText('Beans'));
    //   expect(await getAllByText('item')).toHaveLength(8);
    //   expect(screen.getByText(/£4.10/i)).toBeInTheDocument(); // sub-total value
    ...
    //   expect(await getAllByText('item')).toHaveLength(7);
    //   expect(screen.getByText(/£3.40/i)).toBeInTheDocument(); // sub-total value
